...
class Window(qt.QMainWindow):
    ...
    def __init__(self, superClass, loadCourses):
        ...
        self.pdfBtn = self.findChild(qt.QPushButton, "pdfBtn")
        ...
        self.createCourseBtn = self.findChild(qt.QPushButton, "createCourseBtn")

        # Bind buttons
        self.colorBtn.clicked.connect(self.selectColor)
        self.pdfBtn.clicked.connect(self.selectPDF)
        self.nameEdit.textChanged.connect(self.validateCourse)
        self.topicEdit.textChanged.connect(self.validateTopic)
        self.addTopicBtn.clicked.connect(self.addTopic)
        self.topicListWidget.clicked.connect(self.deleteTopic)
        self.createCourseBtn.clicked.connect(self.createCourse)
