...
from PyQt5.QtChart import QChart, QChartView, QLineSeries, QValueAxis, QCategoryAxis, QPieSeries, QPieSlice
...
class Window(qt.QMainWindow):
    ...
    def __init__(self, superClass, course, color, factsStudied, defStudied, noRemaining, timeTaken,
                 correctCounter, incorrectCounter, scorePerTopic):
        """ Main Window """
        ...
        self.color = color
        self.totalStudied = factsStudied + defStudied
    ...
    def createPieChart(self):
        ...
        chartView.setMinimumHeight(325)
